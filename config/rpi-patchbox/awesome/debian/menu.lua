...
Debian_menu["Debian_Programming"] = {
	{"Sonic Pi","/usr/bin/sonic-pi","/usr/share/pixmaps/sonic-pi.png"},
}
...
Debian_menu["Debian"] = {
	...
	{ "Programming", Debian_menu["Debian_Programming"] },
