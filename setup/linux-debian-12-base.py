...
PATHS = {
    'config_dir': Path("config") / "base" if "base" else None,
...
SECTIONS = [   {   'install': [   'build-essential',
                       'ncdu',
                       'htop',
                       'vim',
                       'exuberant-ctags',
                       ...
                       'open-vm-tools'],
        'name': 'core',
        'post_install': 'mkdir -p ~/.host-shared\n',
        'pre_install': 'sudo apt-get update && sudo apt-get dist-upgrade -y\n',
        'purge': ['snapd'],
        'type': 'debian_packages'},
    {   'install': ['python3-dev', 'python3-setuptools', 'python3-pip'],
        'name': 'python',
        'type': 'debian_packages'},
    {   'install': [   'wheel',
                       'virtualenv',
    ...
    {   'install': [   'libpq-dev',
                       ...
                       'luajit'],
        'name': 'database',
        'post_install': 'sudo -u postgres createuser -s $USER\n'
                        'sudo -u postgres createdb $USER\n',
        'pre_install': '# Add PostgreSQL repository for Debian 12 (Bookworm)\n'
                       ...
                       'https://apt.postgresql.org/pub/repos/apt bookworm-pgdg '
